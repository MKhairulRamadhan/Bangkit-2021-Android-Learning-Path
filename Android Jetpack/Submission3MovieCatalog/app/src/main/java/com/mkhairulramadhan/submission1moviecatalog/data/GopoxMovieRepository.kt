...
class GopoxMovieRepository(private val remoteDataSource: RemoteDataSource) : GopoxMovieDataSource {

    companion object{
        @Volatile
        private var instance: GopoxMovieRepository? = null
        fun getInstance(remoteDataSource: RemoteDataSource): GopoxMovieRepository =
                instance ?: synchronized(this){
                    instance?: GopoxMovieRepository(remoteDataSource)
                }
    }
