package com.mkhairulramadhan.core.data.source.local

import com.mkhairulramadhan.core.data.source.local.entity.TourismEntity
import com.mkhairulramadhan.core.data.source.local.room.TourismDao
